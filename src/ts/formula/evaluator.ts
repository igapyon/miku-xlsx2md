...
(function initXlsx2mdFormulaEvaluator(global: typeof globalThis) {
  ...
  type FormulaFunctionEvaluator = (args: FormulaAstNode[], context: EvaluateFormulaAstContext) => unknown;
  ...
  const LOGICAL_FUNCTION_EVALUATORS: Record<string, FormulaFunctionEvaluator> = {
    IF: evaluateIf,
  ...
  const NUMERIC_FUNCTION_EVALUATORS: Record<string, FormulaFunctionEvaluator> = {
    ABS: evaluateAbs,
    INT: evaluateInt,
  ...
  const DATE_FUNCTION_EVALUATORS: Record<string, FormulaFunctionEvaluator> = {
    DATE: evaluateDate,
  ...
  const TEXT_FUNCTION_EVALUATORS: Record<string, FormulaFunctionEvaluator> = {
    VALUE: evaluateValue,
    REPT: evaluateRept,
  ...
  const LOOKUP_FUNCTION_EVALUATORS: Record<string, FormulaFunctionEvaluator> = {
    MATCH: evaluateMatch,
    INDEX: evaluateIndex,
  ...
  const INFORMATION_FUNCTION_EVALUATORS: Record<string, FormulaFunctionEvaluator> = {
  ...
  const FORMULA_FUNCTION_EVALUATORS: Record<string, FormulaFunctionEvaluator> = {
